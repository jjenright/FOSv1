...
- Added the executive dashboard and four validated charts.

## v0.4.1

- Removed hardcoded balance-sheet verification assumptions.
...
- Added full historical import.

## v0.2.1

- Removed the overlapping FactTransactions AutoFilter.

## v0.2.0

- Completed the current-layout data engine.
